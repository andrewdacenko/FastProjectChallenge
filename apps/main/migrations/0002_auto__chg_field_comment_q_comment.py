...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_comment', 'q_comment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['main.Topic']))

    def backwards(self, orm):

        # Changing field 'Comment.q_comment'
        db.alter_column(u'main_comment', 'q_comment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Topic']))
    ...
    models = {
        ...
        u'main.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'q_comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cc'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['main.Topic']"}),
